...
**-----------------------------------------------------------------------------
**
** $Id: GFopTabbedPanel.java 1170 2011-10-07 16:24:10Z LordEidi $
**
-----------------------------------------------------------------------------*/
...
public class GFopTabbedPanel extends GFopObjectBase
{
	public GFopTabbedPanel(IGozerFrameExtension gfe, GTabbedPanel panel)
	{
		super(gfe);
	}
