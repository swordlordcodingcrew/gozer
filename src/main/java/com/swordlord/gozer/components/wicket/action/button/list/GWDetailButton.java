 ...
 **-----------------------------------------------------------------------------
 **
 ** $Id: GWDetailButton.java 1371 2013-05-26 15:48:00Z LordEidi $
 **
-----------------------------------------------------------------------------*/
...
/**
 * TODO JavaDoc for GWDetailButton.java
 * 
 * @author LordEidi
 * 
 */
@SuppressWarnings("serial")
public class GWDetailButton extends GWAbstractAction
{
    /**
     * @param id
     * @param gc
     * @param actionBase
     */
	public GWDetailButton(String id, GozerController gc, GActionBase actionBase)
	{
        super(id, gc, actionBase, new PackageResourceReference("img"));
        add(new AttributeModifier("value", new Model<String>("Detail")));
        add(new AttributeModifier("alt", new ResourceModel("action.detail")));
        add(new AttributeModifier("title", new ResourceModel("action.detail")));
	}

	@Override
    public String getActionID() {
		return GDetailAction.getObjectTag();
	}
	...
	public void onBeforeRender()
	{
        ...
        pp.add("id", Icons.ICON_TABLE_GO);

        if (_gc.getFrameStatus() != GozerFrameStatus.EDIT && _gc.getGozerFrameExtension().canDetail())
        {
	...
	public void onSubmit()
	{
		...
		// if no page remain on this page, hence do not set response page
		Page page = _gc.detailAction(getDataBinding().getCurrentRow());
    	if(page != null)
		{
