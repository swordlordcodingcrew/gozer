 ...
 **-----------------------------------------------------------------------------
 **
 ** $Id: GWAddReferenceButton.java 1371 2013-05-26 15:48:00Z LordEidi $
 **
-----------------------------------------------------------------------------*/
...
/**
 * TODO JavaDoc for GWAddReferenceButton.java
 * 
 * @author LordEidi
 * 
 */
@SuppressWarnings("serial")
public class GWAddReferenceButton extends GWAbstractAjaxFallbackAction
{
    /**
     * @param id
     * @param gc
     ...
     * @param form
     */
	public GWAddReferenceButton(String id, GozerController gc, GActionBase actionBase, Form<?> form)
	{
        super(id, gc, actionBase, new PackageResourceReference("img"), form);
        add(new AttributeModifier("value", new Model<String>("Reference Add")));
        add(new AttributeModifier("alt", new ResourceModel("action.table_row_add_reference")));
        add(new AttributeModifier("title", new ResourceModel("action.table_row_add_reference")));
	}
