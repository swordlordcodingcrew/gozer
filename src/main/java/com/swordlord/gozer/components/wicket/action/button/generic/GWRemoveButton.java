 ...
 **-----------------------------------------------------------------------------
 **
 ** $Id: GWRemoveButton.java 1371 2013-05-26 15:48:00Z LordEidi $
 **
-----------------------------------------------------------------------------*/
...
/**
 * TODO JavaDoc for GWRemoveButton.java
 * 
 * @author LordEidi
 * 
 */
@SuppressWarnings("serial")
public class GWRemoveButton extends GWAbstractAjaxFallbackAction
{
    /**
     * @param id
     * @param gc
     ...
     * @param form
     */
	public GWRemoveButton(String id, GozerController gc, GActionBase actionBase, Form<?> form)
	{
        super(id, gc, actionBase, new PackageResourceReference("img"), form);
        add(new AttributeModifier("value", new Model<String>("Row Remove")));
        add(new AttributeModifier("alt", new ResourceModel("action.table_row_remove")));
        add(new AttributeModifier("title", new ResourceModel("action.table_row_remove")));
	}
	
	@Override
    public String getActionID()
	{
		return GRemoveAction.getObjectTag();
	}
	...
	public void onBeforeRender()
	{
        ...
        pp.add("id", Icons.ICON_TABLE_ROW_DELETE);

        if (_gc.getFrameStatus() == GozerFrameStatus.EDIT && _gc.getGozerFrameExtension().canDelete())
		{
