 ...
 **-----------------------------------------------------------------------------
 **
 ** $Id: GWToggleButton.java 1371 2013-05-26 15:48:00Z LordEidi $
 **
-----------------------------------------------------------------------------*/
...
/**
 * TODO JavaDoc for GWToggleButton.java
 * 
 * @author LordEidi
 * 
 */
@SuppressWarnings("serial")
public class GWToggleButton extends GWAbstractAjaxFallbackAction
{
    /**
     * @param id
     * @param gc
     ...
     * @param form
     */
	public GWToggleButton(String id, GozerController gc, GActionBase actionBase, Form<?> form)
	{
