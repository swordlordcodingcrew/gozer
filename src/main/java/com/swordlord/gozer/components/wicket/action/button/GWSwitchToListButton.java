 ...
 **-----------------------------------------------------------------------------
 **
 ** $Id: GWSwitchToListButton.java 1371 2013-05-26 15:48:00Z LordEidi $
 **
-----------------------------------------------------------------------------*/
...
/**
 * TODO JavaDoc for GWSwitchToListButton.java
 * 
 * @author LordEidi
 * 
 */
@SuppressWarnings("serial")
public class GWSwitchToListButton extends GWAbstractAction
{
    /**
     * @param id
     * @param gc
     * @param actionBase
     */
	public GWSwitchToListButton(String id, GozerController gc, GActionBase actionBase)
	{
	...
	public void onBeforeRender()
	{
        ...
        pp.add("id", Icons.ICON_APPLICATION_VIEW_LIST);
