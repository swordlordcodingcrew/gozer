 ...
 **-----------------------------------------------------------------------------
 **
 ** $Id: GWLastButton.java 1371 2013-05-26 15:48:00Z LordEidi $
 **
-----------------------------------------------------------------------------*/
...
/**
 * TODO JavaDoc for GWLastButton.java
 * 
 * @author LordEidi
 * 
 */
@SuppressWarnings("serial")
public class GWLastButton extends GWAbstractAction
{
    /**
     * @param id
     * @param gc
	...
	{
		return GLastAction.getObjectTag();
	}
