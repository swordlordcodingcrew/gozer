 ...
 **-----------------------------------------------------------------------------
 **
 ** $Id: GWDeleteButton.java 1371 2013-05-26 15:48:00Z LordEidi $
 **
-----------------------------------------------------------------------------*/
...
/**
 * TODO JavaDoc for GWDeleteButton.java
 * 
 * @author LordEidi
 * 
 */
@SuppressWarnings("serial")
public class GWDeleteButton extends GWAbstractAjaxFallbackAction
{
    /**
     * @param id
     * @param gc
     ...
     * @param form
     */
	public GWDeleteButton(String id, GozerController gc, GActionBase actionBase, Form<?> form)
	{
        super(id, gc, actionBase, new PackageResourceReference("img"), form);
        add(new AttributeModifier("value", new Model<String>("Delete")));
	}

	@Override
    public String getActionID() 
	{
		return GDeleteAction.getObjectTag();
	}
	...
	public void onBeforeRender()
	{
        ...
        pp.add("id", Icons.ICON_ACTIONS_DELETE);

        GozerFrameStatus gfs = _gc.getFrameStatus();
		 if(((gfs == GozerFrameStatus.EDIT) || (gfs == GozerFrameStatus.NEW)) && _gc.getGozerFrameExtension().canDelete())
		 {
