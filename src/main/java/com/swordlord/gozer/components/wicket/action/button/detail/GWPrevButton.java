 ...
 **-----------------------------------------------------------------------------
 **
 ** $Id: GWPrevButton.java 1371 2013-05-26 15:48:00Z LordEidi $
 **
-----------------------------------------------------------------------------*/
...
/**
 * TODO JavaDoc for GWPrevButton.java
 * 
 * @author LordEidi
 * 
 */
@SuppressWarnings("serial")
public class GWPrevButton extends GWAbstractAction
{
    /**
     * @param id
     * @param gc
    ...
    public String getActionID() {
		return GPrevAction.getObjectTag();
	}
