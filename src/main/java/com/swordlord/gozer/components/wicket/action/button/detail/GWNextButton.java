 ...
 **-----------------------------------------------------------------------------
 **
 ** $Id: GWNextButton.java 1371 2013-05-26 15:48:00Z LordEidi $
 **
-----------------------------------------------------------------------------*/
...
/**
 * TODO JavaDoc for GWNextButton.java
 * 
 * @author LordEidi
 * 
 */
@SuppressWarnings("serial")
public class GWNextButton extends GWAbstractAction
{
    /**
     * @param id
     * @param gc
	...
	{
		return GNextAction.getObjectTag();
	}
