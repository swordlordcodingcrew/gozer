 ...
 **-----------------------------------------------------------------------------
 **
 ** $Id: GWNewButton.java 1371 2013-05-26 15:48:00Z LordEidi $
 **
-----------------------------------------------------------------------------*/
...
/**
 * TODO JavaDoc for GWNewButton.java
 * 
 * @author LordEidi
 * 
 */
@SuppressWarnings("serial")
public class GWNewButton extends GWAbstractAjaxFallbackAction
{
    /**
     * @param id
     * @param gc
     ...
     * @param form
     */
	public GWNewButton(String id, GozerController gc, GActionBase actionBase, Form<?> form)
	{
        super(id, gc, actionBase, new PackageResourceReference("img"), form);
        add(new AttributeModifier("value", new Model<String>("New")));
	}

	@Override
    public String getActionID() {
		return GNewAction.getObjectTag();
	}
	...
	public void onBeforeRender()
	{
        ...
        pp.add("id", Icons.ICON_ACTIONS_NEW);
