 ...
 ** -Gozer is not Zuul-
 **
 ** Copyright 2007-12 by SOMAP.org
 ** http://www.somap.org
 **
 ...
 **-----------------------------------------------------------------------------
 **
 ** $Id: AbstractRenderer.java 1356 2012-02-20 13:17:11Z LordEidi $
 **
-----------------------------------------------------------------------------*/
...
{
	private ObjectTree _ot = null;
	
    /**
     * @param ot
     *            Sets the ObjectTree of this renderer
     */
	public AbstractRenderer(ObjectTree ot)
	{
		super();
    ...
    /**
     * @return Returns the ObjectTree of this renderer
     */
    ...
    /**
     * @return The rendered tree as an object tree
     */
