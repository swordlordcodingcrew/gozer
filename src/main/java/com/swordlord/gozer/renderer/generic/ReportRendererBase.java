 ...
 **-----------------------------------------------------------------------------
 **
 ** $Id: ReportRendererBase.java 1170 2011-10-07 16:24:10Z LordEidi $
 **
-----------------------------------------------------------------------------*/
 ...
 * 
 */
public class ReportRendererBase extends AbstractRenderer
{
	private GozerReportExtension _gre = null;

	public ReportRendererBase(ObjectTree ot, GozerReportExtension gre)
	{
		super(ot);
	...
	public GozerReportExtension getGozerReportExtension()
	{
		return _gre;
	}
}
